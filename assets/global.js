...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange(event) {
    ...
    if (!this.currentVariant) {
      ...
      this.updateShareUrl();
      this.updateVariantDetailData();
    }
  }

  updateVariantDetailData(){
    //load metafield data
    const allVariantDetailMetafield = JSON.parse(document.querySelector("#variant_metafield_data").textContent);
    // console.log(allVariantDetailMetafield);

    // replace content
    const variantDetaiContentElement = document.querySelector("#variant-detail-content");
    variantDetaiContentElement.innerHTML = allVariantDetailMetafield[this.currentVariant.id];
  }
